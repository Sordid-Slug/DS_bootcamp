...
# Для запуска cProfile ввести: "python -m cProfile -s tottime -o profiling-tottime.txt financil.py MSFT 'Total Revenue'"
...
class Financial:
    ...
    def get_financial_data(self):
        try:
            ...
            response = httpx.get(self.url, headers={'User-Agent' : 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) '
